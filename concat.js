/* all changes made here will be overwritten eventually*/+function ($) { "use strict";
...
function isoinit(){
  ...
  if (document.getElementById('contentwrapper').addEventListener) {
	...
	document.getElementById('contentwrapper').addEventListener(
      "mousewheel", scrollHorizontally, false);
	// Firefox
	document.getElementById('contentwrapper').addEventListener(
      "DOMMouseScroll", scrollHorizontally, false);
  } else {
	// IE 6/7/8
	document.getElementById('contentwrapper').attachEvent(
      "onmousewheel", scrollHorizontally);
  }
}
